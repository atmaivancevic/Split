...
const genomeDir = "/home/atma/Vertebrates/"
...
func main() {
	...
	for _, gen := range []struct {
		...
		{"PrzewalskiHorse", "Charlie1.0"},
		{"ChinesePangolin", "Charlie1.0"},
		{"DamaralandMolerat", "Charlie1.0"},
		{"Bison", "Charlie1.0"},
		{"Dromedary", "Charlie1.0"},
		{"SnubnosedMonkey", "Charlie1.0"},
		{"BrazilianGuineaPig", "Charlie1.0"},
		{"TibetanPig", "Charlie1.0"},
		{"MongolianHorse", "Charlie1.0"},
		{"WildSheep", "Charlie1.0"},
	} {
